...
void printLevelOrder(AVLTreeNode* node);
...
void testCopyConstructor() {
    ...
    AVLTreeNode* root = (AVLTreeNode*)avl2.getRoot();
...
void testRemoveNodeBST() {
    ...
    cout << "====================== Remove a root node as the only node in the AVLTree ======================" << endl << endl;
    AVLTree a1;
    a1.insert(10, 1);
...
void testLeftRotateInsert() {
    ...
    a1.insert(30, 2);
    a1.insert(40, 3);
    printLevelOrder((AVLTreeNode*)a1.getRoot()); 
    ...
    a2.insert(35, 4); 
    a2.insert(40, 5);  
    printLevelOrder((AVLTreeNode*)a2.getRoot());
    ...
    a3.insert(15, 4);
    a3.insert(18, 5);
    printLevelOrder((AVLTreeNode*)a3.getRoot());
...
void testRightRotateInsert() {
    ...
    a4.insert(3, 7);
    a4.insert(1, 8);
    printLevelOrder((AVLTreeNode*)a4.getRoot());
    ...
    // a5.insert(24, 7);
    // a5.insert(23, 8);
    // printLevelOrder((AVLTreeNode*)a5.getRoot());
    // cout << "Expected output: 30 - 3, 20 - 2, 50 - 1, 10 - 0, 24 - 1, 80 - 0, 23 - 0, 25 - 0" << endl;    
    cout << "========================================================================================" << endl; 
}
...
void testRemoveLeaf() {
    ...
    a12.insert(18, 8);
    a12.remove(50);
    printLevelOrder((AVLTreeNode*)a12.getRoot());
    ...
    a13.insert(18, 8);
    a13.remove(50);
    printLevelOrder((AVLTreeNode*)a13.getRoot());
    ...
    a10.insert(18, 10);
    a10.remove(60);
    printLevelOrder((AVLTreeNode*)a10.getRoot());
    ...
    a11.insert(6, 7);
    a11.remove(60);
    printLevelOrder((AVLTreeNode*)a11.getRoot());
    ...
    a6.insert(35, 9);
    a6.remove(5);
    printLevelOrder((AVLTreeNode*)a6.getRoot());
